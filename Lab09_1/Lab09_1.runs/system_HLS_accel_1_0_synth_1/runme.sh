...
HD_PWD='D:/CENG3430/Lab09_1/Lab09_1.runs/system_HLS_accel_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_HLS_accel_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_HLS_accel_1_0.tcl
