; ModuleID = 'D:/CENG3430/Lab09/solution1/.autopilot/db/a.g.1.bc'
...
; [#uses=1]
define internal fastcc void @"mmult_hw<float, 32>"([32 x float]* %a, [32 x float]* %b, [32 x float]* %out) nounwind {
  call void @llvm.dbg.value(metadata !{[32 x float]* %a}, i64 0, metadata !4392), !dbg !4393 ; [debug line = 44:17] [debug variable = a]
  call void @llvm.dbg.value(metadata !{[32 x float]* %b}, i64 0, metadata !4394), !dbg !4395 ; [debug line = 44:32] [debug variable = b]
  call void @llvm.dbg.value(metadata !{[32 x float]* %out}, i64 0, metadata !4396), !dbg !4397 ; [debug line = 44:47] [debug variable = out]
  call void (...)* @_ssdm_SpecArrayDimSize([32 x float]* %a, i32 32) nounwind, !dbg !4398 ; [debug line = 45:2]
  call void (...)* @_ssdm_SpecArrayDimSize([32 x float]* %b, i32 32) nounwind, !dbg !4400 ; [debug line = 45:32]
  call void (...)* @_ssdm_SpecArrayDimSize([32 x float]* %out, i32 32) nounwind, !dbg !4401 ; [debug line = 45:62]
  call void (...)* @_ssdm_SpecArrayPartition([32 x float]* %a, i32 2, i8* getelementptr inbounds ([9 x i8]* @.str8, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !4402 ; [debug line = 46:1]
  call void (...)* @_ssdm_SpecArrayPartition([32 x float]* %b, i32 1, i8* getelementptr inbounds ([9 x i8]* @.str8, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !4403 ; [debug line = 47:1]
  br label %1, !dbg !4404                         ; [debug line = 50:20]

; <label>:1                                       ; preds = %8, %0
  %ia = phi i32 [ 0, %0 ], [ %ia.1, %8 ]          ; [#uses=4 type=i32]
  %exitcond2 = icmp eq i32 %ia, 32, !dbg !4404    ; [#uses=1 type=i1] [debug line = 50:20]
  br i1 %exitcond2, label %9, label %2, !dbg !4404 ; [debug line = 50:20]

; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([3 x i8]* @.str9, i32 0, i32 0)) nounwind, !dbg !4406 ; [debug line = 51:3]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([3 x i8]* @.str9, i32 0, i32 0)) nounwind, !dbg !4406 ; [#uses=1 type=i32] [debug line = 51:3]
  br label %3, !dbg !4408                         ; [debug line = 52:21]

; <label>:3                                       ; preds = %7, %2
  %ib = phi i32 [ 0, %2 ], [ %ib.1, %7 ]          ; [#uses=4 type=i32]
  %exitcond1 = icmp eq i32 %ib, 32, !dbg !4408    ; [#uses=1 type=i1] [debug line = 52:21]
  br i1 %exitcond1, label %8, label %4, !dbg !4408 ; [debug line = 52:21]

; <label>:4                                       ; preds = %3
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([3 x i8]* @.str10, i32 0, i32 0)) nounwind, !dbg !4410 ; [debug line = 53:4]
  %rbegin3 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([3 x i8]* @.str10, i32 0, i32 0)) nounwind, !dbg !4410 ; [#uses=1 type=i32] [debug line = 53:4]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !4412 ; [debug line = 54:1]
  br label %5, !dbg !4413                         ; [debug line = 56:22]

; <label>:5                                       ; preds = %6, %4
  %sum = phi float [ 0.000000e+00, %4 ], [ %sum.1, %6 ] ; [#uses=2 type=float]
  %id = phi i32 [ 0, %4 ], [ %id.1, %6 ]          ; [#uses=4 type=i32]
  %exitcond = icmp eq i32 %id, 32, !dbg !4413     ; [#uses=1 type=i1] [debug line = 56:22]
  br i1 %exitcond, label %7, label %6, !dbg !4413 ; [debug line = 56:22]

; <label>:6                                       ; preds = %5
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([3 x i8]* @.str11, i32 0, i32 0)) nounwind, !dbg !4415 ; [debug line = 57:5]
  %rbegin5 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([3 x i8]* @.str11, i32 0, i32 0)) nounwind, !dbg !4415 ; [#uses=1 type=i32] [debug line = 57:5]
  %a.addr = getelementptr inbounds [32 x float]* %a, i32 %ia, i32 %id, !dbg !4417 ; [#uses=1 type=float*] [debug line = 58:5]
  %a.load = load float* %a.addr, align 4, !dbg !4417 ; [#uses=2 type=float] [debug line = 58:5]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float %a.load) nounwind
  %b.addr = getelementptr inbounds [32 x float]* %b, i32 %id, i32 %ib, !dbg !4417 ; [#uses=1 type=float*] [debug line = 58:5]
  %b.load = load float* %b.addr, align 4, !dbg !4417 ; [#uses=2 type=float] [debug line = 58:5]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float %b.load) nounwind
  %tmp = fmul float %a.load, %b.load, !dbg !4417  ; [#uses=1 type=float] [debug line = 58:5]
  %sum.1 = fadd float %sum, %tmp, !dbg !4417      ; [#uses=1 type=float] [debug line = 58:5]
  call void @llvm.dbg.value(metadata !{float %sum.1}, i64 0, metadata !4418), !dbg !4417 ; [debug line = 58:5] [debug variable = sum]
  %rend6 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([3 x i8]* @.str11, i32 0, i32 0), i32 %rbegin5) nounwind, !dbg !4419 ; [#uses=0 type=i32] [debug line = 59:4]
  %id.1 = add nsw i32 %id, 1, !dbg !4420          ; [#uses=1 type=i32] [debug line = 56:34]
  call void @llvm.dbg.value(metadata !{i32 %id.1}, i64 0, metadata !4421), !dbg !4420 ; [debug line = 56:34] [debug variable = id]
  br label %5, !dbg !4420                         ; [debug line = 56:34]

; <label>:7                                       ; preds = %5
  %sum.0.lcssa = phi float [ %sum, %5 ]           ; [#uses=1 type=float]
  %out.addr = getelementptr inbounds [32 x float]* %out, i32 %ia, i32 %ib, !dbg !4422 ; [#uses=1 type=float*] [debug line = 60:4]
  store float %sum.0.lcssa, float* %out.addr, align 4, !dbg !4422 ; [debug line = 60:4]
  %rend4 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([3 x i8]* @.str10, i32 0, i32 0), i32 %rbegin3) nounwind, !dbg !4423 ; [#uses=0 type=i32] [debug line = 61:3]
  %ib.1 = add nsw i32 %ib, 1, !dbg !4424          ; [#uses=1 type=i32] [debug line = 52:33]
  call void @llvm.dbg.value(metadata !{i32 %ib.1}, i64 0, metadata !4425), !dbg !4424 ; [debug line = 52:33] [debug variable = ib]
  br label %3, !dbg !4424                         ; [debug line = 52:33]

; <label>:8                                       ; preds = %3
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([3 x i8]* @.str9, i32 0, i32 0), i32 %rbegin) nounwind, !dbg !4426 ; [#uses=0 type=i32] [debug line = 62:2]
  %ia.1 = add nsw i32 %ia, 1, !dbg !4427          ; [#uses=1 type=i32] [debug line = 50:32]
  call void @llvm.dbg.value(metadata !{i32 %ia.1}, i64 0, metadata !4428), !dbg !4427 ; [debug line = 50:32] [debug variable = ia]
  br label %1, !dbg !4427                         ; [debug line = 50:32]

; <label>:9                                       ; preds = %1
  ret void, !dbg !4429                            ; [debug line = 63:3]
}
...
define void @HLS_accel(%struct.ap_axiu.40* %INPUT_STREAM, %struct.ap_axiu.40* %OUTPUT_STREAM) nounwind {
  ...
  call void @llvm.dbg.value(metadata !{%struct.ap_axiu.40* %INPUT_STREAM}, i64 0, metadata !4430), !dbg !4431 ; [debug line = 21:25] [debug variable = INPUT_STREAM]
  call void @llvm.dbg.value(metadata !{%struct.ap_axiu.40* %OUTPUT_STREAM}, i64 0, metadata !4432), !dbg !4433 ; [debug line = 21:55] [debug variable = OUTPUT_STREAM]
  call void (...)* @_ssdm_SpecArrayDimSize(%struct.ap_axiu.40* %OUTPUT_STREAM, i32 1024) nounwind, !dbg !4434 ; [debug line = 22:2]
  call void (...)* @_ssdm_SpecArrayDimSize(%struct.ap_axiu.40* %INPUT_STREAM, i32 2048) nounwind, !dbg !4436 ; [debug line = 22:45]
  call void (...)* @_ssdm_op_SpecInterface(i32 0, i8* getelementptr inbounds ([10 x i8]* @.str, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([12 x i8]* @.str2, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !4437 ; [debug line = 23:1]
  call void (...)* @_ssdm_op_SpecInterface(%struct.ap_axiu.40* %OUTPUT_STREAM, i8* getelementptr inbounds ([5 x i8]* @.str3, i32 0, i32 0), i32 1, i32 1, i8* getelementptr inbounds ([5 x i8]* @.str4, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !4438 ; [debug line = 24:1]
  call void (...)* @_ssdm_op_SpecInterface(%struct.ap_axiu.40* %INPUT_STREAM, i8* getelementptr inbounds ([5 x i8]* @.str3, i32 0, i32 0), i32 1, i32 1, i8* getelementptr inbounds ([5 x i8]* @.str4, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !4439 ; [debug line = 25:1]
  call void @llvm.dbg.value(metadata !{%struct.ap_axiu.40* %INPUT_STREAM}, i64 0, metadata !4440) nounwind, !dbg !4442 ; [debug line = 123:10@36:2] [debug variable = in_stream]
  call void @llvm.dbg.value(metadata !{%struct.ap_axiu.40* %OUTPUT_STREAM}, i64 0, metadata !4443) nounwind, !dbg !4444 ; [debug line = 124:10@36:2] [debug variable = out_stream]
  call void @llvm.dbg.declare(metadata !{[32 x [32 x float]]* %a}, metadata !4445) nounwind, !dbg !4449 ; [debug line = 129:4@36:2] [debug variable = a]
  call void @llvm.dbg.declare(metadata !{[32 x [32 x float]]* %b}, metadata !4450) nounwind, !dbg !4451 ; [debug line = 130:4@36:2] [debug variable = b]
  call void @llvm.dbg.declare(metadata !{[32 x [32 x float]]* %out}, metadata !4452) nounwind, !dbg !4453 ; [debug line = 131:4@36:2] [debug variable = out]
  br label %1, !dbg !4454                         ; [debug line = 136:13@36:2]

; <label>:1                                       ; preds = %3, %0
  %i.0.i = phi i32 [ 0, %0 ], [ %i, %3 ]          ; [#uses=4 type=i32]
  %exitcond5.i = icmp eq i32 %i.0.i, 32, !dbg !4454 ; [#uses=1 type=i1] [debug line = 136:13@36:2]
  br i1 %exitcond5.i, label %.preheader7.i.preheader, label %.preheader8.preheader.i, !dbg !4454 ; [debug line = 136:13@36:2]

.preheader7.i.preheader:                          ; preds = %1
  br label %.preheader7.i, !dbg !4456             ; [debug line = 146:14@36:2]

.preheader8.preheader.i:                          ; preds = %1
  %tmp = shl i32 %i.0.i, 5, !dbg !4458            ; [#uses=1 type=i32] [debug line = 140:17@36:2]
  br label %.preheader8.i, !dbg !4461             ; [debug line = 137:14@36:2]

.preheader8.i:                                    ; preds = %2, %.preheader8.preheader.i
  %j.0.i = phi i32 [ %j, %2 ], [ 0, %.preheader8.preheader.i ] ; [#uses=4 type=i32]
  %exitcond4.i = icmp eq i32 %j.0.i, 32, !dbg !4461 ; [#uses=1 type=i1] [debug line = 137:14@36:2]
  br i1 %exitcond4.i, label %3, label %2, !dbg !4461 ; [debug line = 137:14@36:2]

; <label>:2                                       ; preds = %.preheader8.i
  %rbegin11.i = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str5, i32 0, i32 0)) nounwind, !dbg !4462 ; [#uses=1 type=i32] [debug line = 138:4@36:2]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !4463 ; [debug line = 139:1@36:2]
  %k = add nsw i32 %j.0.i, %tmp, !dbg !4458       ; [#uses=7 type=i32] [debug line = 140:17@36:2]
  call void @llvm.dbg.value(metadata !{i32 %k}, i64 0, metadata !4464) nounwind, !dbg !4458 ; [debug line = 140:17@36:2] [debug variable = k]
  %INPUT_STREAM.addr = getelementptr inbounds %struct.ap_axiu.40* %INPUT_STREAM, i32 %k, i32 0, i32 0, i32 0, i32 0, !dbg !4465 ; [#uses=1 type=i32*] [debug line = 1653:70@81:19@141:14@36:2]
  %INPUT_STREAM.load = load i32* %INPUT_STREAM.addr, align 4, !dbg !4465 ; [#uses=2 type=i32] [debug line = 1653:70@81:19@141:14@36:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %INPUT_STREAM.load) nounwind
  %ret = bitcast i32 %INPUT_STREAM.load to float, !dbg !4470 ; [#uses=1 type=float] [debug line = 82:24@141:14@36:2]
  call void @llvm.dbg.value(metadata !{float %ret}, i64 0, metadata !4471) nounwind, !dbg !4470 ; [debug line = 82:24@141:14@36:2] [debug variable = ret]
  %INPUT_STREAM.addr.1 = getelementptr inbounds %struct.ap_axiu.40* %INPUT_STREAM, i32 %k, i32 2, i32 0, i32 0, i32 0, !dbg !4472 ; [#uses=1 type=i4*] [debug line = 84:43@141:14@36:2]
  %INPUT_STREAM.load.1 = load i4* %INPUT_STREAM.addr.1, align 1, !dbg !4472 ; [#uses=1 type=i4] [debug line = 84:43@141:14@36:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i4 %INPUT_STREAM.load.1) nounwind
  %INPUT_STREAM.addr.2 = getelementptr inbounds %struct.ap_axiu.40* %INPUT_STREAM, i32 %k, i32 1, i32 0, i32 0, i32 0, !dbg !4473 ; [#uses=1 type=i4*] [debug line = 85:43@141:14@36:2]
  %INPUT_STREAM.load.2 = load i4* %INPUT_STREAM.addr.2, align 1, !dbg !4473 ; [#uses=1 type=i4] [debug line = 85:43@141:14@36:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i4 %INPUT_STREAM.load.2) nounwind
  %INPUT_STREAM.addr.3 = getelementptr inbounds %struct.ap_axiu.40* %INPUT_STREAM, i32 %k, i32 3, i32 0, i32 0, i32 0, !dbg !4474 ; [#uses=1 type=i4*] [debug line = 86:35@141:14@36:2]
  %INPUT_STREAM.load.3 = load i4* %INPUT_STREAM.addr.3, align 1, !dbg !4474 ; [#uses=1 type=i4] [debug line = 86:35@141:14@36:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i4 %INPUT_STREAM.load.3) nounwind
  %INPUT_STREAM.addr.4 = getelementptr inbounds %struct.ap_axiu.40* %INPUT_STREAM, i32 %k, i32 4, i32 0, i32 0, i32 0, !dbg !4475 ; [#uses=1 type=i1*] [debug line = 87:35@141:14@36:2]
  %INPUT_STREAM.load.4 = load i1* %INPUT_STREAM.addr.4, align 1, !dbg !4475 ; [#uses=1 type=i1] [debug line = 87:35@141:14@36:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i1 %INPUT_STREAM.load.4) nounwind
  %INPUT_STREAM.addr.5 = getelementptr inbounds %struct.ap_axiu.40* %INPUT_STREAM, i32 %k, i32 5, i32 0, i32 0, i32 0, !dbg !4476 ; [#uses=1 type=i5*] [debug line = 88:32@141:14@36:2]
  %INPUT_STREAM.load.5 = load i5* %INPUT_STREAM.addr.5, align 1, !dbg !4476 ; [#uses=1 type=i5] [debug line = 88:32@141:14@36:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i5 %INPUT_STREAM.load.5) nounwind
  %INPUT_STREAM.addr.6 = getelementptr inbounds %struct.ap_axiu.40* %INPUT_STREAM, i32 %k, i32 6, i32 0, i32 0, i32 0, !dbg !4477 ; [#uses=1 type=i5*] [debug line = 89:36@141:14@36:2]
  %INPUT_STREAM.load.6 = load i5* %INPUT_STREAM.addr.6, align 1, !dbg !4477 ; [#uses=1 type=i5] [debug line = 89:36@141:14@36:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i5 %INPUT_STREAM.load.6) nounwind
  %a.addr.1 = getelementptr inbounds [32 x [32 x float]]* %a, i32 0, i32 %i.0.i, i32 %j.0.i, !dbg !4469 ; [#uses=1 type=float*] [debug line = 141:14@36:2]
  store float %ret, float* %a.addr.1, align 4, !dbg !4469 ; [debug line = 141:14@36:2]
  %rend12.i = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str5, i32 0, i32 0), i32 %rbegin11.i) nounwind, !dbg !4478 ; [#uses=0 type=i32] [debug line = 143:3@36:2]
  %j = add nsw i32 %j.0.i, 1, !dbg !4479          ; [#uses=1 type=i32] [debug line = 137:23@36:2]
  call void @llvm.dbg.value(metadata !{i32 %j}, i64 0, metadata !4480) nounwind, !dbg !4479 ; [debug line = 137:23@36:2] [debug variable = j]
  br label %.preheader8.i, !dbg !4479             ; [debug line = 137:23@36:2]

; <label>:3                                       ; preds = %.preheader8.i
  %i = add nsw i32 %i.0.i, 1, !dbg !4481          ; [#uses=1 type=i32] [debug line = 136:22@36:2]
  call void @llvm.dbg.value(metadata !{i32 %i}, i64 0, metadata !4482) nounwind, !dbg !4481 ; [debug line = 136:22@36:2] [debug variable = i]
  br label %1, !dbg !4481                         ; [debug line = 136:22@36:2]

.preheader7.i:                                    ; preds = %5, %.preheader7.i.preheader
  %i1.0.i = phi i32 [ %i.1, %5 ], [ 0, %.preheader7.i.preheader ] ; [#uses=4 type=i32]
  %exitcond3.i = icmp eq i32 %i1.0.i, 32, !dbg !4456 ; [#uses=1 type=i1] [debug line = 146:14@36:2]
  br i1 %exitcond3.i, label %6, label %.preheader6.preheader.i, !dbg !4456 ; [debug line = 146:14@36:2]

.preheader6.preheader.i:                          ; preds = %.preheader7.i
  %tmp.3 = mul i32 %i1.0.i, 32, !dbg !4483        ; [#uses=1 type=i32] [debug line = 150:22@36:2]
  br label %.preheader6.i, !dbg !4486             ; [debug line = 147:15@36:2]

.preheader6.i:                                    ; preds = %4, %.preheader6.preheader.i
  %j2.0.i = phi i32 [ %j.1, %4 ], [ 0, %.preheader6.preheader.i ] ; [#uses=4 type=i32]
  %exitcond2.i = icmp eq i32 %j2.0.i, 32, !dbg !4486 ; [#uses=1 type=i1] [debug line = 147:15@36:2]
  br i1 %exitcond2.i, label %5, label %4, !dbg !4486 ; [debug line = 147:15@36:2]

; <label>:4                                       ; preds = %.preheader6.i
  %rbegin.i = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str6, i32 0, i32 0)) nounwind, !dbg !4487 ; [#uses=1 type=i32] [debug line = 148:5@36:2]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !4488 ; [debug line = 149:1@36:2]
  %tmp.9 = add i32 %tmp.3, 1024, !dbg !4483       ; [#uses=1 type=i32] [debug line = 150:22@36:2]
  %k.1 = add i32 %tmp.9, %j2.0.i, !dbg !4483      ; [#uses=7 type=i32] [debug line = 150:22@36:2]
  call void @llvm.dbg.value(metadata !{i32 %k.1}, i64 0, metadata !4489) nounwind, !dbg !4483 ; [debug line = 150:22@36:2] [debug variable = k]
  %INPUT_STREAM.addr.7 = getelementptr inbounds %struct.ap_axiu.40* %INPUT_STREAM, i32 %k.1, i32 0, i32 0, i32 0, i32 0, !dbg !4490 ; [#uses=1 type=i32*] [debug line = 1653:70@81:19@151:15@36:2]
  %INPUT_STREAM.load.7 = load i32* %INPUT_STREAM.addr.7, align 4, !dbg !4490 ; [#uses=2 type=i32] [debug line = 1653:70@81:19@151:15@36:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %INPUT_STREAM.load.7) nounwind
  %ret.1 = bitcast i32 %INPUT_STREAM.load.7 to float, !dbg !4493 ; [#uses=1 type=float] [debug line = 82:24@151:15@36:2]
  call void @llvm.dbg.value(metadata !{float %ret.1}, i64 0, metadata !4494) nounwind, !dbg !4493 ; [debug line = 82:24@151:15@36:2] [debug variable = ret]
  %INPUT_STREAM.addr.8 = getelementptr inbounds %struct.ap_axiu.40* %INPUT_STREAM, i32 %k.1, i32 2, i32 0, i32 0, i32 0, !dbg !4495 ; [#uses=1 type=i4*] [debug line = 84:43@151:15@36:2]
  %INPUT_STREAM.load.8 = load i4* %INPUT_STREAM.addr.8, align 1, !dbg !4495 ; [#uses=1 type=i4] [debug line = 84:43@151:15@36:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i4 %INPUT_STREAM.load.8) nounwind
  %INPUT_STREAM.addr.9 = getelementptr inbounds %struct.ap_axiu.40* %INPUT_STREAM, i32 %k.1, i32 1, i32 0, i32 0, i32 0, !dbg !4496 ; [#uses=1 type=i4*] [debug line = 85:43@151:15@36:2]
  %INPUT_STREAM.load.9 = load i4* %INPUT_STREAM.addr.9, align 1, !dbg !4496 ; [#uses=1 type=i4] [debug line = 85:43@151:15@36:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i4 %INPUT_STREAM.load.9) nounwind
  %INPUT_STREAM.addr.10 = getelementptr inbounds %struct.ap_axiu.40* %INPUT_STREAM, i32 %k.1, i32 3, i32 0, i32 0, i32 0, !dbg !4497 ; [#uses=1 type=i4*] [debug line = 86:35@151:15@36:2]
  %INPUT_STREAM.load.10 = load i4* %INPUT_STREAM.addr.10, align 1, !dbg !4497 ; [#uses=1 type=i4] [debug line = 86:35@151:15@36:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i4 %INPUT_STREAM.load.10) nounwind
  %INPUT_STREAM.addr.11 = getelementptr inbounds %struct.ap_axiu.40* %INPUT_STREAM, i32 %k.1, i32 4, i32 0, i32 0, i32 0, !dbg !4498 ; [#uses=1 type=i1*] [debug line = 87:35@151:15@36:2]
  %INPUT_STREAM.load.11 = load i1* %INPUT_STREAM.addr.11, align 1, !dbg !4498 ; [#uses=1 type=i1] [debug line = 87:35@151:15@36:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i1 %INPUT_STREAM.load.11) nounwind
  %INPUT_STREAM.addr.12 = getelementptr inbounds %struct.ap_axiu.40* %INPUT_STREAM, i32 %k.1, i32 5, i32 0, i32 0, i32 0, !dbg !4499 ; [#uses=1 type=i5*] [debug line = 88:32@151:15@36:2]
  %INPUT_STREAM.load.12 = load i5* %INPUT_STREAM.addr.12, align 1, !dbg !4499 ; [#uses=1 type=i5] [debug line = 88:32@151:15@36:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i5 %INPUT_STREAM.load.12) nounwind
  %INPUT_STREAM.addr.13 = getelementptr inbounds %struct.ap_axiu.40* %INPUT_STREAM, i32 %k.1, i32 6, i32 0, i32 0, i32 0, !dbg !4500 ; [#uses=1 type=i5*] [debug line = 89:36@151:15@36:2]
  %INPUT_STREAM.load.13 = load i5* %INPUT_STREAM.addr.13, align 1, !dbg !4500 ; [#uses=1 type=i5] [debug line = 89:36@151:15@36:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i5 %INPUT_STREAM.load.13) nounwind
  %b.addr.1 = getelementptr inbounds [32 x [32 x float]]* %b, i32 0, i32 %i1.0.i, i32 %j2.0.i, !dbg !4492 ; [#uses=1 type=float*] [debug line = 151:15@36:2]
  store float %ret.1, float* %b.addr.1, align 4, !dbg !4492 ; [debug line = 151:15@36:2]
  %rend.i = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str6, i32 0, i32 0), i32 %rbegin.i) nounwind, !dbg !4501 ; [#uses=0 type=i32] [debug line = 152:4@36:2]
  %j.1 = add nsw i32 %j2.0.i, 1, !dbg !4502       ; [#uses=1 type=i32] [debug line = 147:24@36:2]
  call void @llvm.dbg.value(metadata !{i32 %j.1}, i64 0, metadata !4503) nounwind, !dbg !4502 ; [debug line = 147:24@36:2] [debug variable = j]
  br label %.preheader6.i, !dbg !4502             ; [debug line = 147:24@36:2]

; <label>:5                                       ; preds = %.preheader6.i
  %i.1 = add nsw i32 %i1.0.i, 1, !dbg !4504       ; [#uses=1 type=i32] [debug line = 146:23@36:2]
  call void @llvm.dbg.value(metadata !{i32 %i.1}, i64 0, metadata !4505) nounwind, !dbg !4504 ; [debug line = 146:23@36:2] [debug variable = i]
  br label %.preheader7.i, !dbg !4504             ; [debug line = 146:23@36:2]

; <label>:6                                       ; preds = %.preheader7.i
  %a.addr = getelementptr inbounds [32 x [32 x float]]* %a, i32 0, i32 0, !dbg !4506 ; [#uses=1 type=[32 x float]*] [debug line = 155:4@36:2]
  %b.addr = getelementptr inbounds [32 x [32 x float]]* %b, i32 0, i32 0, !dbg !4506 ; [#uses=1 type=[32 x float]*] [debug line = 155:4@36:2]
  %out.addr = getelementptr inbounds [32 x [32 x float]]* %out, i32 0, i32 0, !dbg !4506 ; [#uses=1 type=[32 x float]*] [debug line = 155:4@36:2]
  call fastcc void @"mmult_hw<float, 32>"([32 x float]* %a.addr, [32 x float]* %b.addr, [32 x float]* %out.addr) nounwind, !dbg !4506 ; [debug line = 155:4@36:2]
  br label %7, !dbg !4507                         ; [debug line = 158:15@36:2]

; <label>:7                                       ; preds = %9, %6
  %i4.0.i = phi i32 [ 0, %6 ], [ %i.2, %9 ]       ; [#uses=4 type=i32]
  %exitcond1.i = icmp eq i32 %i4.0.i, 32, !dbg !4507 ; [#uses=1 type=i1] [debug line = 158:15@36:2]
  br i1 %exitcond1.i, label %"wrapped_mmult_hw<float, 32, 1024, 4, 5, 5>.exit", label %.preheader.preheader.i, !dbg !4507 ; [debug line = 158:15@36:2]

.preheader.preheader.i:                           ; preds = %7
  %tmp.7 = shl nsw i32 %i4.0.i, 5, !dbg !4509     ; [#uses=1 type=i32] [debug line = 162:17@36:2]
  br label %.preheader.i, !dbg !4512              ; [debug line = 159:16@36:2]

.preheader.i:                                     ; preds = %8, %.preheader.preheader.i
  %j5.0.i = phi i32 [ %j.2, %8 ], [ 0, %.preheader.preheader.i ] ; [#uses=4 type=i32]
  %exitcond.i = icmp eq i32 %j5.0.i, 32, !dbg !4512 ; [#uses=1 type=i1] [debug line = 159:16@36:2]
  br i1 %exitcond.i, label %9, label %8, !dbg !4512 ; [debug line = 159:16@36:2]

; <label>:8                                       ; preds = %.preheader.i
  %rbegin9.i = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str7, i32 0, i32 0)) nounwind, !dbg !4513 ; [#uses=1 type=i32] [debug line = 160:6@36:2]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !4514 ; [debug line = 161:1@36:2]
  %k.2 = add nsw i32 %j5.0.i, %tmp.7, !dbg !4509  ; [#uses=8 type=i32] [debug line = 162:17@36:2]
  call void @llvm.dbg.value(metadata !{i32 %k.2}, i64 0, metadata !4515) nounwind, !dbg !4509 ; [debug line = 162:17@36:2] [debug variable = k]
  %v.assign = getelementptr inbounds [32 x [32 x float]]* %out, i32 0, i32 %i4.0.i, i32 %j5.0.i, !dbg !4516 ; [#uses=1 type=float*] [debug line = 163:22@36:2]
  %last.assign = icmp eq i32 %k.2, 1023, !dbg !4516 ; [#uses=2 type=i1] [debug line = 163:22@36:2]
  call void @llvm.dbg.value(metadata !{float* %v.assign}, i64 0, metadata !4517) nounwind, !dbg !4518 ; [debug line = 94:97@163:22@36:2] [debug variable = v]
  call void @llvm.dbg.value(metadata !{i1 %last.assign}, i64 0, metadata !4519) nounwind, !dbg !4520 ; [debug line = 94:105@163:22@36:2] [debug variable = last]
  %v.assign.load = load float* %v.assign, align 4, !dbg !4521 ; [#uses=1 type=float] [debug line = 105:2@163:22@36:2]
  %val.assign = bitcast float %v.assign.load to i32, !dbg !4521 ; [#uses=2 type=i32] [debug line = 105:2@163:22@36:2]
  call void @llvm.dbg.value(metadata !{i32 %val.assign}, i64 0, metadata !4523) nounwind, !dbg !4525 ; [debug line = 250:55@106:2@163:22@36:2] [debug variable = val]
  call void @llvm.dbg.value(metadata !{i32 %val.assign}, i64 0, metadata !4526) nounwind, !dbg !4528 ; [debug line = 250:55@250:77@106:2@163:22@36:2] [debug variable = val]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %val.assign) nounwind
  %OUTPUT_STREAM.addr = getelementptr inbounds %struct.ap_axiu.40* %OUTPUT_STREAM, i32 %k.2, i32 0, i32 0, i32 0, i32 0, !dbg !4529 ; [#uses=1 type=i32*] [debug line = 277:10@100:10@163:22@36:2]
  store i32 %val.assign, i32* %OUTPUT_STREAM.addr, align 4, !dbg !4529 ; [debug line = 277:10@100:10@163:22@36:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i4 -1) nounwind
  %OUTPUT_STREAM.addr.1 = getelementptr inbounds %struct.ap_axiu.40* %OUTPUT_STREAM, i32 %k.2, i32 1, i32 0, i32 0, i32 0, !dbg !4533 ; [#uses=1 type=i4*] [debug line = 277:10@100:10@163:22@36:2]
  store i4 -1, i4* %OUTPUT_STREAM.addr.1, align 1, !dbg !4533 ; [debug line = 277:10@100:10@163:22@36:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i4 -1) nounwind
  %OUTPUT_STREAM.addr.2 = getelementptr inbounds %struct.ap_axiu.40* %OUTPUT_STREAM, i32 %k.2, i32 2, i32 0, i32 0, i32 0, !dbg !4533 ; [#uses=1 type=i4*] [debug line = 277:10@100:10@163:22@36:2]
  store i4 -1, i4* %OUTPUT_STREAM.addr.2, align 1, !dbg !4533 ; [debug line = 277:10@100:10@163:22@36:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i4 0) nounwind
  %OUTPUT_STREAM.addr.3 = getelementptr inbounds %struct.ap_axiu.40* %OUTPUT_STREAM, i32 %k.2, i32 3, i32 0, i32 0, i32 0, !dbg !4533 ; [#uses=1 type=i4*] [debug line = 277:10@100:10@163:22@36:2]
  store i4 0, i4* %OUTPUT_STREAM.addr.3, align 1, !dbg !4533 ; [debug line = 277:10@100:10@163:22@36:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i1 %last.assign) nounwind
  %OUTPUT_STREAM.addr.4 = getelementptr inbounds %struct.ap_axiu.40* %OUTPUT_STREAM, i32 %k.2, i32 4, i32 0, i32 0, i32 0, !dbg !4535 ; [#uses=1 type=i1*] [debug line = 277:10@100:10@163:22@36:2]
  store i1 %last.assign, i1* %OUTPUT_STREAM.addr.4, align 1, !dbg !4535 ; [debug line = 277:10@100:10@163:22@36:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i5 0) nounwind
  %OUTPUT_STREAM.addr.5 = getelementptr inbounds %struct.ap_axiu.40* %OUTPUT_STREAM, i32 %k.2, i32 5, i32 0, i32 0, i32 0, !dbg !4537 ; [#uses=1 type=i5*] [debug line = 277:10@100:10@163:22@36:2]
  store i5 0, i5* %OUTPUT_STREAM.addr.5, align 1, !dbg !4537 ; [debug line = 277:10@100:10@163:22@36:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i5 0) nounwind
  %OUTPUT_STREAM.addr.6 = getelementptr inbounds %struct.ap_axiu.40* %OUTPUT_STREAM, i32 %k.2, i32 6, i32 0, i32 0, i32 0, !dbg !4537 ; [#uses=1 type=i5*] [debug line = 277:10@100:10@163:22@36:2]
  store i5 0, i5* %OUTPUT_STREAM.addr.6, align 1, !dbg !4537 ; [debug line = 277:10@100:10@163:22@36:2]
  %rend10.i = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str7, i32 0, i32 0), i32 %rbegin9.i) nounwind, !dbg !4539 ; [#uses=0 type=i32] [debug line = 164:5@36:2]
  %j.2 = add nsw i32 %j5.0.i, 1, !dbg !4540       ; [#uses=1 type=i32] [debug line = 159:25@36:2]
  call void @llvm.dbg.value(metadata !{i32 %j.2}, i64 0, metadata !4541) nounwind, !dbg !4540 ; [debug line = 159:25@36:2] [debug variable = j]
  br label %.preheader.i, !dbg !4540              ; [debug line = 159:25@36:2]

; <label>:9                                       ; preds = %.preheader.i
  %i.2 = add nsw i32 %i4.0.i, 1, !dbg !4542       ; [#uses=1 type=i32] [debug line = 158:24@36:2]
  call void @llvm.dbg.value(metadata !{i32 %i.2}, i64 0, metadata !4543) nounwind, !dbg !4542 ; [debug line = 158:24@36:2] [debug variable = i]
  br label %7, !dbg !4542                         ; [debug line = 158:24@36:2]

"wrapped_mmult_hw<float, 32, 1024, 4, 5, 5>.exit": ; preds = %7
  ret void, !dbg !4544                            ; [debug line = 38:2]
}
...
!4390 = metadata !{void ([32 x float]*, [32 x float]*, [32 x float]*)* @"mmult_hw<float, 32>", metadata !4345, metadata !4346, metadata !4347, metadata !4348, metadata !4391, metadata !4350}
!4391 = metadata !{metadata !"kernel_arg_name", metadata !"a", metadata !"b", metadata !"out"}
!4392 = metadata !{i32 786689, metadata !2563, metadata !"a", metadata !2509, i32 16777260, metadata !879, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4393 = metadata !{i32 44, i32 17, metadata !2563, null}
!4394 = metadata !{i32 786689, metadata !2563, metadata !"b", metadata !2509, i32 33554476, metadata !879, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4395 = metadata !{i32 44, i32 32, metadata !2563, null}
!4396 = metadata !{i32 786689, metadata !2563, metadata !"out", metadata !2509, i32 50331692, metadata !879, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4397 = metadata !{i32 44, i32 47, metadata !2563, null}
!4398 = metadata !{i32 45, i32 2, metadata !4399, null}
!4399 = metadata !{i32 786443, metadata !2563, i32 45, i32 1, metadata !2509, i32 37} ; [ DW_TAG_lexical_block ]
!4400 = metadata !{i32 45, i32 32, metadata !4399, null}
!4401 = metadata !{i32 45, i32 62, metadata !4399, null}
!4402 = metadata !{i32 46, i32 1, metadata !4399, null}
!4403 = metadata !{i32 47, i32 1, metadata !4399, null}
!4404 = metadata !{i32 50, i32 20, metadata !4405, null}
!4405 = metadata !{i32 786443, metadata !4399, i32 50, i32 5, metadata !2509, i32 38} ; [ DW_TAG_lexical_block ]
!4406 = metadata !{i32 51, i32 3, metadata !4407, null}
!4407 = metadata !{i32 786443, metadata !4405, i32 51, i32 2, metadata !2509, i32 39} ; [ DW_TAG_lexical_block ]
!4408 = metadata !{i32 52, i32 21, metadata !4409, null}
!4409 = metadata !{i32 786443, metadata !4407, i32 52, i32 6, metadata !2509, i32 40} ; [ DW_TAG_lexical_block ]
!4410 = metadata !{i32 53, i32 4, metadata !4411, null}
!4411 = metadata !{i32 786443, metadata !4409, i32 53, i32 3, metadata !2509, i32 41} ; [ DW_TAG_lexical_block ]
!4412 = metadata !{i32 54, i32 1, metadata !4411, null}
!4413 = metadata !{i32 56, i32 22, metadata !4414, null}
!4414 = metadata !{i32 786443, metadata !4411, i32 56, i32 7, metadata !2509, i32 42} ; [ DW_TAG_lexical_block ]
!4415 = metadata !{i32 57, i32 5, metadata !4416, null}
!4416 = metadata !{i32 786443, metadata !4414, i32 57, i32 4, metadata !2509, i32 43} ; [ DW_TAG_lexical_block ]
!4417 = metadata !{i32 58, i32 5, metadata !4416, null}
!4418 = metadata !{i32 786688, metadata !4411, metadata !"sum", metadata !2509, i32 55, metadata !881, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4419 = metadata !{i32 59, i32 4, metadata !4416, null}
!4420 = metadata !{i32 56, i32 34, metadata !4414, null}
!4421 = metadata !{i32 786688, metadata !4414, metadata !"id", metadata !2509, i32 56, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4422 = metadata !{i32 60, i32 4, metadata !4411, null}
!4423 = metadata !{i32 61, i32 3, metadata !4411, null}
!4424 = metadata !{i32 52, i32 33, metadata !4409, null}
!4425 = metadata !{i32 786688, metadata !4409, metadata !"ib", metadata !2509, i32 52, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4426 = metadata !{i32 62, i32 2, metadata !4407, null}
!4427 = metadata !{i32 50, i32 32, metadata !4405, null}
!4428 = metadata !{i32 786688, metadata !4405, metadata !"ia", metadata !2509, i32 50, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4429 = metadata !{i32 63, i32 3, metadata !4399, null}
!4430 = metadata !{i32 786689, metadata !884, metadata !"INPUT_STREAM", metadata !876, i32 16777237, metadata !887, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4431 = metadata !{i32 21, i32 25, metadata !884, null}
!4432 = metadata !{i32 786689, metadata !884, metadata !"OUTPUT_STREAM", metadata !876, i32 33554453, metadata !887, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!4433 = metadata !{i32 21, i32 55, metadata !884, null}
!4434 = metadata !{i32 22, i32 2, metadata !4435, null}
!4435 = metadata !{i32 786443, metadata !884, i32 22, i32 1, metadata !876, i32 1} ; [ DW_TAG_lexical_block ]
!4436 = metadata !{i32 22, i32 45, metadata !4435, null}
!4437 = metadata !{i32 23, i32 1, metadata !4435, null}
!4438 = metadata !{i32 24, i32 1, metadata !4435, null}
!4439 = metadata !{i32 25, i32 1, metadata !4435, null}
!4440 = metadata !{i32 786689, metadata !2508, metadata !"in_stream", metadata !2509, i32 16777339, metadata !887, i32 0, metadata !4441} ; [ DW_TAG_arg_variable ]
!4441 = metadata !{i32 36, i32 2, metadata !4435, null}
!4442 = metadata !{i32 123, i32 10, metadata !2508, metadata !4441}
!4443 = metadata !{i32 786689, metadata !2508, metadata !"out_stream", metadata !2509, i32 33554556, metadata !887, i32 0, metadata !4441} ; [ DW_TAG_arg_variable ]
!4444 = metadata !{i32 124, i32 10, metadata !2508, metadata !4441}
!4445 = metadata !{i32 786688, metadata !4446, metadata !"a", metadata !2509, i32 129, metadata !4447, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4446 = metadata !{i32 786443, metadata !2508, i32 125, i32 1, metadata !2509, i32 2} ; [ DW_TAG_lexical_block ]
!4447 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 32768, i64 32, i32 0, i32 0, metadata !881, metadata !4448, i32 0, i32 0} ; [ DW_TAG_array_type ]
!4448 = metadata !{metadata !883, metadata !883}
!4449 = metadata !{i32 129, i32 4, metadata !4446, metadata !4441}
!4450 = metadata !{i32 786688, metadata !4446, metadata !"b", metadata !2509, i32 130, metadata !4447, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4451 = metadata !{i32 130, i32 4, metadata !4446, metadata !4441}
!4452 = metadata !{i32 786688, metadata !4446, metadata !"out", metadata !2509, i32 131, metadata !4447, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!4453 = metadata !{i32 131, i32 4, metadata !4446, metadata !4441}
!4454 = metadata !{i32 136, i32 13, metadata !4455, metadata !4441}
!4455 = metadata !{i32 786443, metadata !4446, i32 136, i32 2, metadata !2509, i32 3} ; [ DW_TAG_lexical_block ]
!4456 = metadata !{i32 146, i32 14, metadata !4457, metadata !4441}
!4457 = metadata !{i32 786443, metadata !4446, i32 146, i32 3, metadata !2509, i32 6} ; [ DW_TAG_lexical_block ]
!4458 = metadata !{i32 140, i32 17, metadata !4459, metadata !4441}
!4459 = metadata !{i32 786443, metadata !4460, i32 138, i32 3, metadata !2509, i32 5} ; [ DW_TAG_lexical_block ]
!4460 = metadata !{i32 786443, metadata !4455, i32 137, i32 3, metadata !2509, i32 4} ; [ DW_TAG_lexical_block ]
!4461 = metadata !{i32 137, i32 14, metadata !4460, metadata !4441}
!4462 = metadata !{i32 138, i32 4, metadata !4459, metadata !4441}
!4463 = metadata !{i32 139, i32 1, metadata !4459, metadata !4441}
!4464 = metadata !{i32 786688, metadata !4459, metadata !"k", metadata !2509, i32 140, metadata !56, i32 0, metadata !4441} ; [ DW_TAG_auto_variable ]
!4465 = metadata !{i32 1653, i32 70, metadata !4466, metadata !4467}
!4466 = metadata !{i32 786443, metadata !2562, i32 1653, i32 68, metadata !865, i32 36} ; [ DW_TAG_lexical_block ]
!4467 = metadata !{i32 81, i32 19, metadata !4468, metadata !4469}
!4468 = metadata !{i32 786443, metadata !2559, i32 72, i32 1, metadata !2509, i32 35} ; [ DW_TAG_lexical_block ]
!4469 = metadata !{i32 141, i32 14, metadata !4459, metadata !4441}
!4470 = metadata !{i32 82, i32 24, metadata !4468, metadata !4469}
!4471 = metadata !{i32 786688, metadata !4468, metadata !"ret", metadata !2509, i32 82, metadata !881, i32 0, metadata !4469} ; [ DW_TAG_auto_variable ]
!4472 = metadata !{i32 84, i32 43, metadata !4468, metadata !4469}
!4473 = metadata !{i32 85, i32 43, metadata !4468, metadata !4469}
!4474 = metadata !{i32 86, i32 35, metadata !4468, metadata !4469}
!4475 = metadata !{i32 87, i32 35, metadata !4468, metadata !4469}
!4476 = metadata !{i32 88, i32 32, metadata !4468, metadata !4469}
!4477 = metadata !{i32 89, i32 36, metadata !4468, metadata !4469}
!4478 = metadata !{i32 143, i32 3, metadata !4459, metadata !4441}
!4479 = metadata !{i32 137, i32 23, metadata !4460, metadata !4441}
!4480 = metadata !{i32 786688, metadata !4460, metadata !"j", metadata !2509, i32 137, metadata !56, i32 0, metadata !4441} ; [ DW_TAG_auto_variable ]
!4481 = metadata !{i32 136, i32 22, metadata !4455, metadata !4441}
!4482 = metadata !{i32 786688, metadata !4455, metadata !"i", metadata !2509, i32 136, metadata !56, i32 0, metadata !4441} ; [ DW_TAG_auto_variable ]
!4483 = metadata !{i32 150, i32 22, metadata !4484, metadata !4441}
!4484 = metadata !{i32 786443, metadata !4485, i32 148, i32 4, metadata !2509, i32 8} ; [ DW_TAG_lexical_block ]
!4485 = metadata !{i32 786443, metadata !4457, i32 147, i32 4, metadata !2509, i32 7} ; [ DW_TAG_lexical_block ]
!4486 = metadata !{i32 147, i32 15, metadata !4485, metadata !4441}
!4487 = metadata !{i32 148, i32 5, metadata !4484, metadata !4441}
!4488 = metadata !{i32 149, i32 1, metadata !4484, metadata !4441}
!4489 = metadata !{i32 786688, metadata !4484, metadata !"k", metadata !2509, i32 150, metadata !56, i32 0, metadata !4441} ; [ DW_TAG_auto_variable ]
!4490 = metadata !{i32 1653, i32 70, metadata !4466, metadata !4491}
!4491 = metadata !{i32 81, i32 19, metadata !4468, metadata !4492}
!4492 = metadata !{i32 151, i32 15, metadata !4484, metadata !4441}
!4493 = metadata !{i32 82, i32 24, metadata !4468, metadata !4492}
!4494 = metadata !{i32 786688, metadata !4468, metadata !"ret", metadata !2509, i32 82, metadata !881, i32 0, metadata !4492} ; [ DW_TAG_auto_variable ]
!4495 = metadata !{i32 84, i32 43, metadata !4468, metadata !4492}
!4496 = metadata !{i32 85, i32 43, metadata !4468, metadata !4492}
!4497 = metadata !{i32 86, i32 35, metadata !4468, metadata !4492}
!4498 = metadata !{i32 87, i32 35, metadata !4468, metadata !4492}
!4499 = metadata !{i32 88, i32 32, metadata !4468, metadata !4492}
!4500 = metadata !{i32 89, i32 36, metadata !4468, metadata !4492}
!4501 = metadata !{i32 152, i32 4, metadata !4484, metadata !4441}
!4502 = metadata !{i32 147, i32 24, metadata !4485, metadata !4441}
!4503 = metadata !{i32 786688, metadata !4485, metadata !"j", metadata !2509, i32 147, metadata !56, i32 0, metadata !4441} ; [ DW_TAG_auto_variable ]
!4504 = metadata !{i32 146, i32 23, metadata !4457, metadata !4441}
!4505 = metadata !{i32 786688, metadata !4457, metadata !"i", metadata !2509, i32 146, metadata !56, i32 0, metadata !4441} ; [ DW_TAG_auto_variable ]
!4506 = metadata !{i32 155, i32 4, metadata !4446, metadata !4441}
!4507 = metadata !{i32 158, i32 15, metadata !4508, metadata !4441}
!4508 = metadata !{i32 786443, metadata !4446, i32 158, i32 4, metadata !2509, i32 9} ; [ DW_TAG_lexical_block ]
!4509 = metadata !{i32 162, i32 17, metadata !4510, metadata !4441}
!4510 = metadata !{i32 786443, metadata !4511, i32 160, i32 5, metadata !2509, i32 11} ; [ DW_TAG_lexical_block ]
!4511 = metadata !{i32 786443, metadata !4508, i32 159, i32 5, metadata !2509, i32 10} ; [ DW_TAG_lexical_block ]
!4512 = metadata !{i32 159, i32 16, metadata !4511, metadata !4441}
!4513 = metadata !{i32 160, i32 6, metadata !4510, metadata !4441}
!4514 = metadata !{i32 161, i32 1, metadata !4510, metadata !4441}
!4515 = metadata !{i32 786688, metadata !4510, metadata !"k", metadata !2509, i32 162, metadata !56, i32 0, metadata !4441} ; [ DW_TAG_auto_variable ]
!4516 = metadata !{i32 163, i32 22, metadata !4510, metadata !4441}
!4517 = metadata !{i32 786689, metadata !2514, metadata !"v", metadata !2509, i32 16777310, metadata !2517, i32 0, metadata !4516} ; [ DW_TAG_arg_variable ]
!4518 = metadata !{i32 94, i32 97, metadata !2514, metadata !4516}
!4519 = metadata !{i32 786689, metadata !2514, metadata !"last", metadata !2509, i32 33554526, metadata !212, i32 0, metadata !4516} ; [ DW_TAG_arg_variable ]
!4520 = metadata !{i32 94, i32 105, metadata !2514, metadata !4516}
!4521 = metadata !{i32 105, i32 2, metadata !4522, metadata !4516}
!4522 = metadata !{i32 786443, metadata !2514, i32 95, i32 1, metadata !2509, i32 12} ; [ DW_TAG_lexical_block ]
!4523 = metadata !{i32 786689, metadata !2535, metadata !"val", metadata !894, i32 33554682, metadata !56, i32 0, metadata !4524} ; [ DW_TAG_arg_variable ]
!4524 = metadata !{i32 106, i32 2, metadata !4522, metadata !4516}
!4525 = metadata !{i32 250, i32 55, metadata !2535, metadata !4524}
!4526 = metadata !{i32 786689, metadata !2536, metadata !"val", metadata !894, i32 33554682, metadata !56, i32 0, metadata !4527} ; [ DW_TAG_arg_variable ]
!4527 = metadata !{i32 250, i32 77, metadata !2535, metadata !4524}
!4528 = metadata !{i32 250, i32 55, metadata !2536, metadata !4527}
!4529 = metadata !{i32 277, i32 10, metadata !4530, metadata !4531}
!4530 = metadata !{i32 786443, metadata !2539, i32 276, i32 92, metadata !894, i32 28} ; [ DW_TAG_lexical_block ]
!4531 = metadata !{i32 100, i32 10, metadata !4532, metadata !4516}
!4532 = metadata !{i32 786443, metadata !2553, i32 100, i32 10, metadata !890, i32 34} ; [ DW_TAG_lexical_block ]
!4533 = metadata !{i32 277, i32 10, metadata !4534, metadata !4531}
!4534 = metadata !{i32 786443, metadata !2534, i32 276, i32 92, metadata !894, i32 24} ; [ DW_TAG_lexical_block ]
!4535 = metadata !{i32 277, i32 10, metadata !4536, metadata !4531}
!4536 = metadata !{i32 786443, metadata !2529, i32 276, i32 92, metadata !894, i32 20} ; [ DW_TAG_lexical_block ]
!4537 = metadata !{i32 277, i32 10, metadata !4538, metadata !4531}
!4538 = metadata !{i32 786443, metadata !2524, i32 276, i32 92, metadata !894, i32 16} ; [ DW_TAG_lexical_block ]
!4539 = metadata !{i32 164, i32 5, metadata !4510, metadata !4441}
!4540 = metadata !{i32 159, i32 25, metadata !4511, metadata !4441}
!4541 = metadata !{i32 786688, metadata !4511, metadata !"j", metadata !2509, i32 159, metadata !56, i32 0, metadata !4441} ; [ DW_TAG_auto_variable ]
!4542 = metadata !{i32 158, i32 24, metadata !4508, metadata !4441}
!4543 = metadata !{i32 786688, metadata !4508, metadata !"i", metadata !2509, i32 158, metadata !56, i32 0, metadata !4441} ; [ DW_TAG_auto_variable ]
!4544 = metadata !{i32 38, i32 2, metadata !4435, null}
