...
HD_PWD='D:/CENG3430/Lab07/Lab07.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stopwatch_system_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stopwatch_system_wrapper.tcl
