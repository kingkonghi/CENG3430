...
HD_PWD='D:/CENG3430/Lab07/Lab07.runs/stopwatch_system_stopwatch_controller_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stopwatch_system_stopwatch_controller_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stopwatch_system_stopwatch_controller_0_0.tcl
