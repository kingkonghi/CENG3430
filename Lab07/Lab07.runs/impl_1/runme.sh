...
HD_PWD='D:/CENG3430/Lab07/Lab07.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stopwatch_system_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stopwatch_system_wrapper.tcl -notrace
