...
HD_PWD='D:/CENG3430/Final_Project/Final_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RunningBlock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RunningBlock.tcl
