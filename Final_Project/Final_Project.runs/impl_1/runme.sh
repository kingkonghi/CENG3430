...
HD_PWD='D:/CENG3430/Final_Project/Final_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RunningBlock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RunningBlock.tcl -notrace
